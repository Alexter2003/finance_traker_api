...
], UpdateExpenseTypeDto.prototype, "name", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Tipo de categoría de gasto',
        enum: client_1.ExpenseCategoryType,
        example: client_1.ExpenseCategoryType.VARIABLE,
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(client_1.ExpenseCategoryType),
    __metadata("design:type", String)
], UpdateExpenseTypeDto.prototype, "type", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
    ...
    __metadata("design:type", String)
], UpdateExpenseTypeDto.prototype, "description", void 0);
